  ...
  return (
    <>
      <div className="container signIn-main d-flex flex-column justify-content-center">
        <div className="container border pt-4 px-5 rounded-3">
          ...
          <div className="form-floating mb-3">
            <input type="email" className="form-control" id="email" placeholder="Email or phone" name='email' value={Credentials.email} onChange={OnChange} />
